...
- New check functions:
  ...
  - `check_avail`
- Optionally tool executable paths to `axel` and `wget`, to reduce the
  number of times
  [`echoconda::find_packages`](https://rdrr.io/pkg/echoconda/man/find_packages.html)
  is run.
...
- Fix
  [`echoconda::find_packages`](https://rdrr.io/pkg/echoconda/man/find_packages.html)
  (now that this returns a data.table).
